...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="{{ url('/css/admin-home.css')}}" />
    ...
    <div class="row mt-3">
      ...
      <div class="col-12 col-lg-6 col-xl-3">
        <div class="card gradient-orange pull-up">
          <div class="card-body">
             <h5 class="text-white mb-0">0<span class="float-right"><i class="fas fa-dollar-sign"></i></span></h5>
               <div class="progress my-3" style="height:3px;">
                  <div class="progress-bar" style="width:55%"></div>
               </div>
      ...
      <div class="col-12 col-lg-6 col-xl-3">
        <div class="card gradient-ohhappiness pull-up">
           <div class="card-body">
             <h5 class="text-white mb-0">{{$counter}}<span class="float-right"><i class="far fa-user"></i></span></h5>
               <div class="progress my-3" style="height:3px;">
                  <div class="progress-bar" style="width:55%">1</div>
               </div>
      ...
      <div class="col-12 col-lg-6 col-xl-3">
        <div class="card gradient-ibiza pull-up">
           <div class="card-body">
             <h5 class="text-white mb-0">0<span class="float-right"><i class="fas fa-feather-alt"></i></span></h5>
               <div class="progress my-3" style="height:3px;">
                  <div class="progress-bar" style="width:55%">1</div>
               </div>
